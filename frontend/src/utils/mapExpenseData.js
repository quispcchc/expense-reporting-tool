...
const mapExpenseData = (data, mode) => {
    ...
    if (mode === VIEW_MODE.CREATE) {
        ...
        return data.map((expense, index) => ({
            ...
            accountNumberDisplay: expense.account_number_display,
            costCentre: expense.cost_centre_id,
            costCentreCode: expense.cost_centre_code,
            costCentreDescription: expense.cost_centre_description,
            ...
            projectNameDisplay: expense.project_name_display,
